  ...
  return (
    <div className="portfolio-wrapper">
      ...
      <aside className="side-panel">
        <div className="brand-logo">John<span>.</span></div>
      ...
      <main className="main-content">
        ...
        <header id="hero" className="editorial-hero">
          <div className="hero-text-side">
            <div className="hero-badge-row">FULL STACK DEVELOPER // UI DESIGNER</div>
            <h1 className="massive-title">
              JOHN<br />
              <span className="stroke-text">BOTCHOY</span><br />
              B. AVILA
            </h1>
            <div className="hero-accent-line"></div>
            <div className="hero-editorial-footer">
              <p className="hero-lead-text">
                Crafting clean, purposeful digital experiences — where thoughtful code meets refined design. I build things that are as beautiful as they are functional.
              </p>
              <div className="hero-cta-group">
                <a href="#projects" className="action-btn-primary">EXPLORE WORK ↓</a>
                <a href="#contact" className="action-btn-secondary">SAY HELLO</a>
              </div>
            </div>
          </div>
          ...
          <div className="hero-image-side">
            <div className="reactive-photo-frame">
              <img src={profileImg} alt="John Botchoy B. Avila" className="hero-profile-img" />
            </div>
          </div>
        </header>
        ...
        <section id="about" className="profile-section">
          <div className="section-header-row">
            ...
            <h2 className="section-main-title">Designing with purpose, building with precision.</h2>
          </div>
          ...
          <div className="profile-layout-grid">
            <div className="profile-text-column">
              <div className="editorial-paragraph">
                <h5>WHO I AM</h5>
                <p>I am a dedicated and committed <strong>Full Stack Developer</strong> currently pursuing a Bachelor of Science in Computer Science at <strong>St. Nicholas College</strong>. I am passionate about building scalable, efficient, and user-focused digital solutions while continuously expanding my expertise in modern web technologies. I strive to develop clean, intuitive, and high-performing applications that deliver meaningful user experiences and real-world impact.</p>
              </div>
              <div className="editorial-paragraph">
                <h5>WHAT I DO</h5>
                <p>I develop complete digital experiences — from <strong>thoughtfully designed user interfaces</strong> to reliable back-end systems. My work includes <strong>responsive web applications</strong>, Flutter mobile apps, and scalable database solutions, all built with clean, efficient, and maintainable code.</p>
              </div>
            </div>
            ...
            <div className="profile-interactive-column">
              <div className="floating-cv-card">
                ...
                <p>Access full structural details regarding academic timeline, technical benchmarks, and training histories.</p>
                <div className="cv-actions-stack">
                  <button className="btn-solid-dark" onClick={handleViewResume}>
                    VIEW DIGITAL CV
                  </button>
                  <button className="btn-outline-dark" onClick={handleDownloadResume}>
                    ↓ DOWNLOAD AS PDF
                  </button>
                </div>
              </div>
        ...
        <section id="skills" className="stack-section">
          ...
          <p className="stack-intro-text">Every tool here has earned its place through practical projects, late nights, and problems worth solving.</p>
          ...
          <div className="horizontal-stack-layout">
            <div className="stack-row-item">
              ...
              <div className="stack-pills-container">
                <span>React</span><span>HTML5</span><span>CSS3</span><span>JavaScript</span><span>Tailwind CSS</span>
              </div>
            </div>
            ...
            <div className="stack-row-item">
              ...
              <div className="stack-pills-container">
                <span>Laravel</span><span>PHP</span><span>AdonisJS</span><span>Firebase</span><span>Node.js</span>
              </div>
            </div>
            ...
            <div className="stack-row-item">
              ...
              <div className="stack-pills-container">
                <span>MySQL</span><span>Firestore</span><span>Redis</span>
              </div>
            </div>
            ...
            <div className="stack-row-item">
              ...
              <div className="stack-pills-container">
                <span>Flutter</span><span>Dart</span><span>Firebase Auth</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="projects" className="creations-section">
          ...
          <div className="editorial-github-footer">
            <div className="git-left">
              ...
              <a href="https://github.com/Choyiiee" target="_blank" rel="noreferrer">GITHUB.COM/CHOYIIEE ↗</a>
            </div>
            <a href="https://github.com/Choyiiee" target="_blank" rel="noreferrer" className="git-circle-btn">VIEW ALL</a>
          </div>
        </section>
        ...
        <section id="contact" className="connect-section">
          <div className="section-header-row">
            ...
            <h2 className="section-main-title">Let's build something <span className="italicized-serif">together.</span></h2>
          </div>
          ...
          <div className="connect-split-layout">
            <div className="connect-form-panel">
              <form onSubmit={handleSubmit} className="minimal-form">
                ...
                <div className="input-block">
                  ...
                  <textarea name="message" placeholder="Describe your concept or structural goals..." required></textarea>
                </div>
                <div className="form-action-footer">
                  <button type="submit" className="form-submit-btn">{formStatus}</button>
                  <span className="form-notice">TYPICAL RESPONSE TIME // 24 HOURS</span>
                </div>
              </form>
            </div>
            ...
            <div className="connect-cards-panel">
              <div className="editorial-contact-links">
                <a href="mailto:johnavilawork@gmail.com" className="row-link-item">
                  <span className="link-tag">EMAIL</span>
                  <span className="link-text">johnavilawork@gmail.com</span>
                </a>
                <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="row-link-item">
                  <span className="link-tag">LINKEDIN</span>
                  <span className="link-text">John Botchoy B. Avila</span>
                </a>
                <a href="https://github.com/Choyiiee" target="_blank" rel="noreferrer" className="row-link-item">
